...
package com.vivian.ihome.manager;
...
public class IHPreferenceManager {
    private static SharedPreferences sPreferences;
    private static IHPreferenceManager sIHPreferenceManager = null;

    private static final String APP_VERSION_CODE = "app_version_code";
    private static final String APP_SKIN_INDEX = "app_skin_index";

    private IHPreferenceManager(Context context) {
        sPreferences = PreferenceManager.getDefaultSharedPreferences(context.getApplicationContext());
    }

    public static final IHPreferenceManager getInstance(Context context) {
        if (sIHPreferenceManager == null) {
            sIHPreferenceManager = new IHPreferenceManager(context);
        }
        return sIHPreferenceManager;
    }
/*
